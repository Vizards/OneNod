...
## Configured shell plugins

Use enabled bare commands normally. For binding, PATH coverage, or plugin-specific
troubleshooting, read [Shell plugins](shell-plugins.md).
